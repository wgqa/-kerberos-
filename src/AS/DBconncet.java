...
public class DBconncet {protected static final String JTextField = null;
    ...
    public static Connection connect() {
        ...
        try {
            ...
            //一开始必须填一个已经存在的数据库
            String url = "jdbc:mysql://localhost:3306/wangluo?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&failOverReadOnly=false";;
            conn = DriverManager.getConnection(url, "root", "mousesys");
